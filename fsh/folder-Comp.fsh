...
* subject 1..1
// TODO: Sushi doesn't understand that I just want to increase the cardionality constraints. It throws error that the extension already exists
//* extension contains TypeOfList named typeOfList 1..
